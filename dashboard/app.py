...
def _battle_analysis_prompt(battles, counts, *, specific=False):
    ...
    prompt = (
        ...
        "- Whether YOUR weapons/passives actually helped (did the heal/WP passive keep a pet "
        "alive, or was it wasted).\n\n"
        "Then give build advice — but base it on the specific weapons and passives seen in "
        "the data, not generic tips. Reason about what to gear, level, or swap and WHY given "
        "the enemy patterns.\n\n"
        ...
        "3. **Sửa build** — concrete, prioritised changes grounded in the weapons/passives/"
        "stats actually seen.\n\n"
        f"BATTLES:\n{battles_text}"
    )
    return prompt, None
